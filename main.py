        ...
        if searched is None:
            ...
            if def_nota == "Nota 1":
                ...
                for x in searched:
                    ...
                    tabela.setItem(row, 2, QtWidgets.QTableWidgetItem(f"{b[0]}"))
                    tabela.setItem(row, 3, QtWidgets.QTableWidgetItem(f"{b[1]}"))
                    tabela.setItem(row, 4, QtWidgets.QTableWidgetItem(f"{b[2]}"))
                    row += 1 
